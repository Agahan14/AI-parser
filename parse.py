...
def extract_investor_info(url: str):
    ...
    investor_profile_data = extract_html_from_url(url)

    user_data = llm_chain.invoke(
        input={"information": investor_profile_data},
    )


extract_investor_info("https://www.intelcapital.com/team/jennifer-ard/")
